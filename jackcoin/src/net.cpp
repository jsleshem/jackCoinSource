...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "jackcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"jackcointools.com", "54.202.52.142"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"jackcointools.com", "testnet-seed.jackcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. jackcoin is probably already running."), addrBind.ToString().c_str());
        else
